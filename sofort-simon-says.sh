#!/usr/bin/env bash
# Simon Says — Kamera + Stimme brauchen http://
set -e
PORT=8772
...
if port_open; then
  ...
  echo $! >"$DIR/.simon-says-server.pid"
...
echo "Chrome öffnet Simon Says — Kamera erlauben." >&2
URL="http://127.0.0.1:$PORT/simon-says.html"
...
echo "Chrome nicht gefunden: $URL" >&2
